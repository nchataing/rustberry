...
pub fn read_partition_table(card: &SdCard) -> Result<[Partition; 4], MbrError> {
    ...
    let magic_val = mbr_block[BLOCK_SIZE - 2] as u16 * 0x100 + mbr_block[BLOCK_SIZE - 1] as u16;
    if magic_val != MAGIC {
