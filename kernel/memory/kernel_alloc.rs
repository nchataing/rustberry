...
impl KernelAllocator
{
    ...
    {
        KernelAllocator { first_free_block: None }
    }
    ...
    unsafe fn add_pages(&mut self, nb: usize)
    {
        ...
        {
            let fst_header = fst_new_page.to_addr() as *mut BlockDescriptor;
        ...
        else { header = fst_new_page.to_addr() as *mut FreeBlock }

        let footer = (fst_new_page.to_addr() as *mut BlockDescriptor)
