...
// This module has been entirely written by the Rust team and stripped down to
// this no_std, no_alloc basic crate only exporting interfaces.

//! Traits, helpers, and type definitions for core I/O functionality.
//!
//! The documentation of this module is directly taken from the std::io module
//! and might not be 100% accurate for this reduced feature library.
//!
